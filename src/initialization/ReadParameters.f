...
c      open(unit=10,status="old",file="../run/"//card)
      ...
      do
         ...
         if(str(1:1).ne."#")then
            ...
            if(str(1:lp).eq."NXLHA")    read(str(lu:50),*) NXLHA
            if(str(1:lp).eq."NXMLHA")   read(str(lu:50),*) NXMLHA
            if(str(1:lp).eq."NQ2LHA")   read(str(lu:50),*) NQ2LHA
            if(str(1:lp).eq."Q2MINLHA") read(str(lu:50),*) Q2MINLHA
            if(str(1:lp).eq."Q2MAXLHA") read(str(lu:50),*) Q2MAXLHA
            if(str(1:lp).eq."XMINLHA")  read(str(lu:50),*) XMINLHA
            if(str(1:lp).eq."XMLHA")    read(str(lu:50),*) XMLHA
            if(str(1:lp).eq."XMAXLHA")  read(str(lu:50),*) XMAXLHA
         endif
      enddo
 101  close(10)
*
