...
*
************************************************************************
      DOUBLE COMPLEX FUNCTION G11QQ_SIDIS(N, M)
*
      IMPLICIT NONE
*
      include "../commons/consts.h"
...
*
      ...
      S2M = ZETA2 - DPSI(M1,1)
*
      G11QQ_SIDIS = 2 * CF * ( - 8D0 - 1D0 / MS + 2D0 / M1**2 + 1D0 / NS
     1     + ( ( 1D0 + M + N )**2 - 1D0 ) / M / M1 / N / N1 + 3D0 * S2M
     2     - S2N + ( S1M + S1N ) * ( S1M + S1N - 1D0 / M / M1
     2     - 1D0 / N / N1 ) )
*
...
*
************************************************************************
      DOUBLE COMPLEX FUNCTION G11GQ_SIDIS(N, M)
*
      IMPLICIT NONE
*
      include "../commons/consts.h"
...
*
      ...
      S1M = EMC + PSI(M1)
*
      G11GQ_SIDIS = 2 * CF * ( ( 2D0 - 2D0 * M - 9D0 * MS + M**3 - M**4
     1     + M**5 ) / MS / MM**2 / M1**2 + 2D0 * M / N / M1 / MM
     2     - ( 2D0 - M + MS ) / M / M1 / MM / N1
     3     - ( 2D0 + M + MS ) * ( S1M + S1N ) / M / M1 / MM
     4     - 2D0 / M1 / N / N1 )
...
*
************************************************************************
      DOUBLE COMPLEX FUNCTION G11QG_SIDIS(N, M)
*
      IMPLICIT NONE
*
      include "../commons/consts.h"
