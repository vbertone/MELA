...
e_p^2P_{f\gamma}^{V,(0)}+\left(\frac{\alpha}{4\pi}\right)^2e_p^4P_{f\gamma}^{V,(1)}\\
\\
...
2n_\ell P_{\ell \gamma} & {P}_{\ell\ell} & P_{\ell u}^{\rm PS}& P_{\ell d}^{\rm PS}\\
2N_cn_u P_{u \gamma} & P_{u\ell}^{\rm PS} & {P}_{uu} & P_{ud}^{\rm PS} \\
2N_cn_d P_{d \gamma} & P_{d\ell}^{\rm PS} & P_{du}^{\rm PS} & {P}_{dd}
\end{pmatrix}
\begin{pmatrix}
\gamma\\
\Sigma_\ell\\
